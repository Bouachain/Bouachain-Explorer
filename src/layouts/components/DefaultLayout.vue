    ...
    <div
      ...
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10" src="../../assets/boua.png" />
          ...
          <div class="collapse-content"> 
            <div v-for="(el, key) of item?.children" class="menu bg-base-100 w-full !p-0">
              <RouterLink v-if="isNavLink(el)" @click="sidebarShow = false"
                class="hover:bg-gray-100 dark:hover:bg-[#000000] rounded cursor-pointer px-3 py-2 flex items-center"
                :class="{
      ...
      <div class="px-2">
        ...
        <RouterLink to="/wallet/suggest"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#000000]">
        ...
        <a href="https://x.com/Bouachain" target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#000000]">
        ...
        <a v-if="showDiscord" href="https://discord.gg/aqCTKNfWTh" target="_blank"
          class="py-2 px-4 flex items-center rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-[#000000]">
